...
async function main() {
  ...
  const started = await request("tools/call", { name: "run_task", arguments: { workspace, task: "Reply with exactly OK. Do not use tools or modify files.", model: "GLM-High", mode: "plan" } });
